    ...
    <div className="flex min-h-screen items-center justify-center bg-background p-4">
      <Card className="w-full max-w-md border-0 shadow-xl shadow-primary/5">
        <CardHeader className="text-center">
          ...
          <CardDescription>
            Sua conta ainda não foi ativada no sistema. Entre em contato com o administrador do seu escritório para que seu perfil seja criado e você possa acessar o BPM Office.
          </CardDescription>
        </CardHeader>
