...
import { Download, Database, HardDrive, Settings } from "lucide-react";
import {
  getBackups,
  createManualBackup,
  getOfficeBackupConfig,
...
export default function EscritorioBackupPage() {
  ...
  async function handleSaveConfig(e: React.FormEvent) {
    ...
    const result = await saveOfficeBackupConfig({
      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Crie um backup completo do escritório agora.
            </CardDescription>
          </CardHeader>
          <CardContent>
